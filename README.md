...
# USAGE
```
rm rf-Julmi-page-group_uid_extract
git clone https://github.com/JAAT-BRAND/Julmi-page-group_uid_extract
cd Julmi-page-group_uid_extract
python Julmi-page-group_uid_extract.py
```
...
![Image](https://i.ibb.co/XZw6pqm2/Screenshot-20250210-081929-Termux.jpg)
![Image]()
